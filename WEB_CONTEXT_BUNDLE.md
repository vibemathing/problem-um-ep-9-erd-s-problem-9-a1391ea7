...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-9-erd-s-problem-9-a1391ea7-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-9"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-9-erd-s-problem-9-a1391ea7-v1",
      "problem_contract_sha256": "eafee587bb2a751e1151eb67303d4884fd9650abe0320b2e76543b79a8bed125",
      "problem_id": "problem:um-ep-9-erd-s-problem-9-a1391ea7",
      "route_id": "route:um-ep-9-erd-s-problem-9-a1391ea7-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-9-erd-s-problem-9-a1391ea7-source-fidelity-01",
      "graph_id": "graph:um-ep-9-erd-s-problem-9-a1391ea7-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-9-erd-s-problem-9-a1391ea7-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-9-erd-s-problem-9-a1391ea7-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $A$ be the set of all odd integers not of the form $p+2^{k}+2^l$ (where $k,l\\geq 0$ and $p$ is prime). Is the upper density of $A$ positive?"
          },
          "statement_sha256": "852b4572abda9aabaf42f6b1df54fd69a5e76b9f340ba9409c888125d50de944"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-9-erd-s-problem-9-a1391ea7-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-9-erd-s-problem-9-a1391ea7-root",
      "route_id": "route:um-ep-9-erd-s-problem-9-a1391ea7-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-9-7ef6dc18ffb2",
        "url": "https://www.unsolvedmath.com/problems/EP-9"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
